...
canada_subcommittees <- read.csv("canada_subcommittees.csv")

# number of non-joint committees
acronym <- canada_subcommittees$committee_acronym[canada_subcommittees$super_committee_type != "Joint Committees"]
x <- length(acronym)
# number of joint committees
acronym_j <- canada_subcommittees$committee_acronym[canada_subcommittees$super_committee_type == "Joint Committees"]
z <- length(acronym_j)
...
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees/Sub-committees/DateChange')
for(i in 1:x){
  for (j in 1:y){
...
####################
rownames(df) <- c()
canada_subcommittee_date_change <- df

setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees')
write.csv(canada_subcommittee_date_change, "canada_subcommittee_date_change.csv")
