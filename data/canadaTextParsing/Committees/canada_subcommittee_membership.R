...
df <- read.csv("canada_subcommittee_date_change.csv")
name <- read.csv("canada_subcommittees.csv")
...
df_aa <- df_a %>%
  filter(super_committee_type != "Joint Committees")
df_ab <- df_a %>%
  filter(super_committee_type == "Joint Committees")
...
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees/Sub-committees/Membership')
for(i in 1:xa){
...
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees/Sub-committees/Membership_j')
for(i in 1:xb){
...
# bind two dataset
raw_canada_subcommittee_membership <- rbind(df,df_j)

setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees')
# write.csv(raw_canada_subcommittee_membership, "raw_canada_subcommittee_membership.csv")

###########
# clean 
###########
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees')
df <- read.csv("raw_canada_subcommittee_membership.csv")
df_a <- read_excel("raw_canada_subcommittees.xlsx")
...
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees')
committee <- read.csv("canada_subcommittees.csv")
...
# finish!
canada_subcommittee_membership <- df_h
setwd('~/Documents/GitHub/CompLegFall2019/data/canadaTextParsing/Committees')
write.csv(canada_subcommittee_membership, "canada_subcommittee_membership.csv")
