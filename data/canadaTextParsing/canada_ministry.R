...
# [0-9] matches any SINGLE character between 0 and 9 (i.e., a digit), where dash (-) denotes the range
allMinisters$start_year <- str_extract(allMinisters$startDate, "[0-9]{4}")
dat$start_month <- str_extract(allMinisters$startDate, "^[0-9]{1,2}")
